...
export class BugDetailComponent implements OnInit {
    ...
    constructor(private bugService: BugService, private route: ActivatedRoute, private authService: AuthService) {}
    ...
    addComment() {
        if (this.newComment?.trim() && this.bug) {
            const comment: Comment = {
                author: this.authService.getUserName() ?? "Anonymous", // fallback if null
